(function(root) {
    ...
    */
    var Furniture = function Furniture(game, type, x, y) {
        ...
        // if(this.mixins){
        //     for(var i = this.mixins.length - 1; i >= 0; i--){
        //         var mixin = this.mixins[i];
        //         Furniture.Mixins[mixin](this);
        //     }
        // }
    ...
    Furniture.Mixins = {
        pushable: (function(){
            ...
            var push = {
                canResolve: function(source, settings){
                ...
                resolve: function(source, settings){
                    var prevX = this.x,
                        prevY = this.y,
                        pusherX = source.x,
                        pusherY = source.y,
            ...
            return function(furniture){
                furniture.actions = furniture.actions || {};

                furniture.pushable = true;
                furniture.actions.push = {
                    canResolve: push.canResolve,
        ...
        door: (function(){
            ...
            return function(furniture){
                ...
                furniture.open = false;
                furniture.actions.open = {
                    canResolve: open.canResolve,
                    resolve: open.resolve
                };

                furniture.actions.close = {
                    canResolve: close.canResolve,
